<script>
	...
	const md = markdownit();
	import storytext from '$lib/storytext/D/D2.md?raw';
	...
	<div class="flex flex-col lg:flex-row justify-center lg:justify-between items-center w-5/6 lg:w-full md:h-auto">
		...
		<div class="card p-4 w-3/4 h-full mb-5 lg:m-3">
			...
			<div class="w-full flex justify-center">
				<a class="btn variant-filled-primary rounded-xl min-w-[25%] my-5" href="/B_level/C_level/D_level/E_level/E2">Continue</a>
			</div>
		</div>
